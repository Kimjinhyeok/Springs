...
<div class="wrapper row3">
	...
	<div class="content three_quarter">
		...
		<img class="imgr borderedbox inspace-5"
			src="${path}/img/demo/imgr.gif" alt="">
		<p>Aliquatjusto quisque nam consequat doloreet vest orna partur
			scetur portortis nam. Metadipiscing eget facilis elit sagittis felisi
			eger id justo maurisus convallicitur.</p>
		<p>
		...
		<img class="imgl borderedbox inspace-5"
			src="${path}/img/demo/imgl.gif" alt="">
		<p>
		...
		<p>
			...
			template and associated files. For more website templates visit our <a
				href="http://www.os-templates.com/">free website templates</a>
			section.
		</p>
		<p>Portortornec condimenterdum eget consectetuer condis consequam
			pretium pellus sed mauris enim. Puruselit mauris nulla hendimentesque
			elit semper nam a sapien urna sempus.</p>
		<h1>Table(s)</h1>
		...
		<div id="comments">
			...
			<ul>
				<li>
					<article>
						<header>
							<figure class="avatar">
								<img src="${path}/img/demo/avatar.png" alt="">
							</figure>
							<address>
								By <a href="#">A Name</a>
							</address>
			...
			<form action="#" method="post">
				...
				<div class="one_third">
					<label for="url">Website</label> <input type="url" name="url"
